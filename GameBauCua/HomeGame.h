...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnDat->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->btnTom->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->btnCua->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->btnCa->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->btnGa->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->btnBau->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->btnNai->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->txtSodu->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->groupBox3->Enter += gcnew System::EventHandler(this, &HomeGame::groupBox3_Enter);
			// 
			// userName
			// 
			...
			this->MaximumSize = System::Drawing::Size(480, 699);
			this->MinimumSize = System::Drawing::Size(480, 540);
